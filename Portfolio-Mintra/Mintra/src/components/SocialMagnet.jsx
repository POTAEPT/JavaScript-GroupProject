...
const SOCIALS = [
  { name: 'LinkedIn', url: '', icon: ICONS.LinkedIn },
  { name: 'GitHub', url: 'https://github.com/bkmintra', icon: ICONS.GitHub },
  { name: 'X', url: '', icon: ICONS.Twitter },
  { name: 'Mail', url: 'mailto:bkmintra@gmail.com', icon: ICONS.Mail },
];
