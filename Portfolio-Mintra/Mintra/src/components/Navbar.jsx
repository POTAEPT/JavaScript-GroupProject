  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-30 p-4 sm:p-6">
      <nav className="container flex items-center justify-between mx-auto">
        {/* Logo */}
        <a href="https://drive.google.com/file/d/1_jFpJRRGdWqvc1tHdy08JEyudStJ8UmL/view?usp=drive_link">
          <img src={logo} alt="Logo" className="w-48 h-48" /> {/* Adjust size as needed */}
        </a>
