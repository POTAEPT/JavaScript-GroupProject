...
export default function Hero() {
  const skills = ['UI/UX Designer', 'Frontend Developer', 'Backend Developer','AI Developer'];
    ...
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="relative z-20 flex items-center justify-center w-full h-full p-8 text-center bg-black/20 pointer-events-none sm:p-16 md:p-24">
        <div className="w-full max-w-5xl pointer-events-auto">
          <h1 className="font-pixel flex items-center justify-center text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold text-white [text-shadow:0_3px_5px_rgb(0_0_0/40%)] whitespace-nowrap">
            <WordRotate words={greetings} />
            <span className="shrink-0">, I'm Mintra</span>
          </h1>
          ...
          <div className="flex justify-center mt-4">
            <RotatingText
              texts={skills}
              mainClassName="text-lg text-white/90 md:text-xl lg:text-2xl [text-shadow:0_2px_4px_rgb(0_0_0/40%)]"
          ...
          <div className="flex justify-center gap-4 mt-8">
            ...
            <a
              href="https://drive.google.com/file/d/1_jFpJRRGdWqvc1tHdy08JEyudStJ8UmL/view?usp=drive_link"
              target="_blank"
